...
func makeWorker(namespace string, region string, sshKey *string, infrastructureStatus *azureapi.InfrastructureStatus, pools ...extensionsv1alpha1.WorkerPool) *extensionsv1alpha1.Worker {
	var (
...
func makeCluster(shootVersion, region string, machineTypes []apiv1alpha1.MachineType, machineImages []apiv1alpha1.MachineImages, faultDomainCount int32) *extensionscontroller.Cluster {
...
func makeInfrastructureStatus(resourceGroupName, vnetName, subnetName string, zoned bool, vnetrg, availabilitySetID, identityID *string) *azureapi.InfrastructureStatus {
	var infrastructureStatus = azureapi.InfrastructureStatus{
		ResourceGroup: azureapi.ResourceGroup{
			Name: resourceGroupName,
		},
		Networks: azureapi.NetworkStatus{
