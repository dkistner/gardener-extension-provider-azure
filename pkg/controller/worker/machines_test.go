...
var _ = Describe("Machines", func() {
	...
	Context("workerDelegate", func() {
		...
		Describe("#DeployMachineDependencies", func() {
		...
		Describe("#CleanupMachineDependencies", func() {
			It("should return no error", func() {
...
func expectStatusContainsMachineImages(c *mockclient.MockClient, statusWriter *mockclient.MockStatusWriter, worker *extensionsv1alpha1.Worker, images []apiv1alpha1.MachineImage) {
	...
	c.EXPECT().Get(context.TODO(), gomock.Any(), gomock.AssignableToTypeOf(&extensionsv1alpha1.Worker{})).DoAndReturn(func(_ context.Context, _ client.ObjectKey, w *extensionsv1alpha1.Worker) error {
		w = workerWithExpectedStatus.DeepCopy()
		return nil
	})
