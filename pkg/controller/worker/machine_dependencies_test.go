...
var _ = Describe("MachinesDependencies", func() {
	...
	Describe("VMO Dependencies", func() {
		...
		Context("#DeployMachineDependencies", func() {
			It("should deploy no vmo dependency as it not required", func() {
		...
		Context("#CleanupMachineDependencies", func() {
			...
			It("should cleanup a vmo dependency as corresponding worker pool does not exists anymore", func() {
				var (
